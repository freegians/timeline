...
CREATE TABLE `FOLLOWER` (
  ...
  PRIMARY KEY (`ID`),
  UNIQUE KEY `USER_ID_AND_FOLLOWER_ID` (`USER_ID`,`FOLLOWER_ID`)
...
CREATE TABLE `TIMELINE` (
  ...
  `LAST_UPDATE` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '글 수정 시간',
...
CREATE TABLE `USERS` (
  ...
  `LAST_UPDATE` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '사용자 수정 일시',
  PRIMARY KEY (`USER_ID`),
